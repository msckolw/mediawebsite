    ...
    <div className="legal-page">
      <div className="legal-container">
        ...
        <section>
          ...
          <ol>
            <li>
              Cancellations will only be considered if the request is made <strong>2 days</strong> of placing the order. However,
            ...
            <li>
              <strong>The NoBias Media (7001414991)</strong> does not accept cancellation requests for perishable items like flowers, eatables, etc.
            ...
            <li>
              In case of any refunds approved by <strong>The NoBias Media (7001414991)</strong>, it will take <strong>2 days</strong> for the refund to be processed
              to you.
            </li>
          </ol>
        </section>
